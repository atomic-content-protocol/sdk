...
npx @atomic-content-protocol/cli --vault ./my-vault create --title "My First ACO" --body "..."
npx @atomic-content-protocol/cli --vault ./my-vault enrich <id>   # id printed by create
```
